...
- **Removed clock icon from image export:** Eliminated the clock icon from depot time slots in PlanningExportView.tsx to simplify the exported image design and avoid alignment issues. Time slots now display as clean text without decorative icons.
